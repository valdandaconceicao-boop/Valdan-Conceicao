  ...
  return (
    <footer className="bg-black/20 text-center py-6">
      <div className="container mx-auto px-6">
        <p className="text-gray-400">&copy; {currentYear} Kaze Sushi. Todos os direitos reservados.</p>
        <div className="flex justify-center space-x-4 mt-4">
            <a href="#" className="text-gray-400 hover:text-[#ff7e67] transition-colors">
